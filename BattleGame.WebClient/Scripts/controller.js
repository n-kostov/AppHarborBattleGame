...
BullsAndCows.controller = (function () {
    var AccessController = Class.create({
        init: function (dataPersister, controlerContainer) {
            ...
            BullsAndCows.ui.generateLoginButtons(this.controlerContainer);
        },
        ...
        showScores: function () {
            ...
            this.persister.user.getAllUserScores().then(function (data) {
                self.scoresGrid = new BullsAndCows.ui.GridViewControl();
        ...
        handleLoginProcedure: function (deferred) {
            ...
            loginControler.on('click', function () {
                ...
                BullsAndCows.ui.generateLoginForm("#login-container");
            ...
            registerControler.on('click', function () {
                $("#login-container").hide();
                $("#register-container").hide();
                BullsAndCows.ui.generateRegisterForm("#register-container");
    ...
    var GameController = Class.create({
        init: function (dataPersister, controlerContainer) {
            ...
            this.battleControl = new BullsAndCows.ui.BattleControl();
